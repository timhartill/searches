...
python search_runner.py \
        ...
        --algo_heur astar_negg lb_nbs_f_eps lb_nbb_f_eps lb_fwd_first_none_f_eps lb_bwd_first_none_f_eps lb_alter_first_none_f_eps lb_pohl_first_none_f_eps lb_rand_first_none_f_eps lb_lowg_first_none_f_eps lb_smallg_first_none_f_eps lb_smallgf_first_none_f_eps lb_mostedges_first_none_f_eps lb_mostconnectednodes_first_none_f_eps lb_nbb_1stbucket_f_eps lb_nbb_1stbucket_a_eps lb_nbb_rand_f_eps lb_nbb_all_f_eps lb_nbb_smallblowestg_f_eps lb_nbb_smallbhighg_f_eps lb_nbb_smallblowg_f_eps lb_nbb_connec_f_eps lb_nbb_connln_f_eps \
        --algo_mcts NONE
