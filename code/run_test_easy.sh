...
python search_runner.py \
        ...
        --algo_heur lb_nbs_f_eps lb_nbs_f_eps_bpmx1 lb_alter_first_none_bae_a lb_alter_first_none_bae_a_bpmx1 lb_pohl_first_none_bae_a lb_minb_first_none_bae_a lb_rand_first_none_bae_a \
        --algo_mcts NONE
