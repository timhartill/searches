...
SEARCH_MAP = {
    ...
    "lb_nbs_fifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'FIFO', "version": 'A', "min_edge_cost": 1.0},  
    "lb_nbs_lifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'LIFO', "version": 'A', "min_edge_cost": 1.0},  
    "lb_nbs_rand_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'R', "version": 'A', "min_edge_cost": 1.0},  

    "lb_nbs_fifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0},  
    "lb_nbs_lifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'LIFO', "version": 'F', "min_edge_cost": 1.0},  
    "lb_nbs_rand_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'R', "version": 'F', "min_edge_cost": 1.0},  

    "lb_nbb_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'NONE', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_nbb_fifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'FIFO', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_nbb_lifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'LIFO', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_nbb_rand_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'R', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  

    "lb_nbb_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_nbb_fifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_nbb_lifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'LIFO', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_nbb_rand_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'R', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  

    "lb_nbb_highg_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'NONE', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highg_fifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'FIFO', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highg_lifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'LIFO', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highg_rand_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'R', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  

    "lb_nbb_highg_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highg_fifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highg_lifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'LIFO', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highg_rand_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHG', "tb_order": 'R', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  

    "lb_nbb_highf_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'NONE', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highf_fifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'FIFO', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highf_lifo_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'LIFO', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highf_rand_a_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'R', "version": 'A', "min_edge_cost": 1.0 ,"data_struct": 'B'},  

    "lb_nbb_highf_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highf_fifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highf_lifo_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'LIFO', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    "lb_nbb_highf_rand_f_eps": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'FHF', "tb_order": 'R', "version": 'F', "min_edge_cost": 1.0 ,"data_struct": 'B'},  
    ...
    "lb_mwvcsmallg_firstlowg_fifo_dvcbs_f_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'F', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallg_firstlowg_fifo_dvcbs_a_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'F', "tb_order": 'FIFO', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  

    "lb_lowg_smallblowestg_f_eps": {"class": bd_lb_search, "tb_dir": 'G', "tb_select": 'SLG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_smallgf_smallbhighg_f_eps": {"class": bd_lb_search, "tb_dir": 'SB', "tb_select": 'SB', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mostedges_connec_f_eps": {"class": bd_lb_search, "tb_dir": 'EC', "tb_select": 'EC', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    ...
    "lb_smallg_smallg_none_f_eps": {"class": bd_lb_search, "tb_dir": 'S', "tb_select": 'SG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallg_mwvcsmallg_none_f_eps": {"class": bd_lb_search, "tb_dir": 'SM', "tb_select": 'SM', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallg_lowg_rand_f_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'R', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallg_lowg_fifo_dvcbs_f_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallgf_lowg_fifo_dvcbs_f_eps": {"class": bd_lb_search, "tb_dir": 'SBM0', "tb_select": 'SLG', "tb_order": 'FIFO', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mostconnectednodes_connln_f_eps": {"class": bd_lb_search, "tb_dir": 'LN', "tb_select": 'LN', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    ...
    "lb_mwvcsmallg_lowg_rand_a_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'R', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
    ...
    "lb_mwvcsmallgf_lowg_fifo_dvcbs_a_eps": {"class": bd_lb_search, "tb_dir": 'SBM0', "tb_select": 'SLG', "tb_order": 'FIFO', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
    ...
    "lb_gbfhs_gbfhs_a_eps": {"class": bd_lb_search, "tb_dir": 'GBF', "tb_select": 'GBF', "tb_order": 'NONE', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
...
#    "lb_nbs_f_eps_himp": {"class": bd_lb_search, "tb_dir": 'NBS', "tb_select": 'F', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "h_improve": True},  
    ...
    "lb_mwvcsmallg_lowg_none_dvcbs_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', "bpmx1": True},  
    "lb_mwvcsmallgf_lowg_none_dvcbs_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'SBM0', "tb_select": 'SLG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', "bpmx1": True},  
    "lb_mwvcsmallgf_lowg_none_dvcbs_f_eps_uf_bpmx1": {"class": bd_lb_search, "tb_dir": 'SBM0', "tb_select": 'SLG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True, "bpmx1": True},  
    ...
    "lb_mwvcsmallg_lowg_none_dvcbs_f_eps_uf_bpmx1": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True, "bpmx1": True},  
...
#    "lb_pohl_first_none_bae_f_eps_ug_himp": {"class": bd_lb_search, "tb_dir": 'P', "tb_select": 'F', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'D', 'switch_after_U_set':True, "h_improve": True},
    ...
    "lb_rand_first_none_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'R', "tb_select": 'F', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "bpmx1": True},  
    "lb_pohl_first_none_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'P', "tb_select": 'F', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "bpmx1": True},  
    "lb_gbfhs_first_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'GBF', "tb_select": 'F', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "bpmx1": True},  
    "lb_smallg_lowg_none_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'S0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', "bpmx1": True},  
    "lb_smallg_lowg_none_f_eps_uf_bpmx1": {"class": bd_lb_search, "tb_dir": 'S0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True, "bpmx1": True},  
    "lb_smallgf_smallblowg_f_eps_bpmx1": {"class": bd_lb_search, "tb_dir": 'SB', "tb_select": 'SBL', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', "bpmx1": True},  
    "lb_smallgf_smallblowg_f_eps_uf_bpmx1": {"class": bd_lb_search, "tb_dir": 'SB', "tb_select": 'SBL', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True, "bpmx1": True},  
...
# (50) inconsistent h uf bpmx: lb_mwvcsmallg_lowg_none_dvcbs_a_eps_uf_bpmx1 lb_mwvcsmallg_lowg_none_dvcbs_f_eps_uf_bpmx1 lb_mwvcsmallgf_lowg_none_dvcbs_f_eps_uf_bpmx1 lb_gbfhs_gbfhs_f_eps_uf_bpmx1 lb_gbfhs_lowg_f_eps_uf_bpmx1 lb_mostconnectednodes_lowg_f_eps_uf_bpmx1 lb_smallg_lowg_none_f_eps_uf_bpmx1 lb_smallgf_smallblowg_f_eps_uf_bpmx1 
...
#    "lb_pohl_first_none_bae_i_eps_himp": {"class": bd_lb_search, "tb_dir": 'P', "tb_select": 'F', "tb_order": 'NONE', "version": 'I', "min_edge_cost": 1.0, "data_struct": 'D', "h_improve": True},
    ...
    # lb_rand_first_none_f_eps lb_gbfhs_first_f_eps lb_pohl_first_none_f_eps lb_nbs_f_eps lb_smallg_lowg_none_f_eps lb_smallgf_smallblowg_f_eps

    # Non-UF versions of DVCHS, GBFHS, Most connected, SmallestG, smallestGF run on all std problems:
    "lb_mwvcsmallg_lowg_none_dvcbs_a_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'A', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallg_lowg_none_dvcbs_f_eps": {"class": bd_lb_search, "tb_dir": 'SM0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_mwvcsmallgf_lowg_none_dvcbs_f_eps": {"class": bd_lb_search, "tb_dir": 'SBM0', "tb_select": 'SLG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    ...
    "lb_mostconnectednodes_lowg_f_eps": {"class": bd_lb_search, "tb_dir": 'LN0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_smallg_lowg_none_f_eps": {"class": bd_lb_search, "tb_dir": 'S0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  
    "lb_smallgf_smallblowg_f_eps": {"class": bd_lb_search, "tb_dir": 'SB', "tb_select": 'SBL', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B'},  

    # lb_mwvcsmallg_lowg_none_dvcbs_a_eps lb_mwvcsmallg_lowg_none_dvcbs_f_eps lb_mwvcsmallgf_lowg_none_dvcbs_f_eps lb_gbfhs_gbfhs_f_eps lb_gbfhs_lowg_f_eps lb_mostconnectednodes_lowg_f_eps lb_smallg_lowg_none_f_eps lb_smallgf_smallblowg_f_eps
    # lb_mwvcsmallg_lowg_none_dvcbs_a_eps lb_mwvcsmallg_lowg_none_dvcbs_f_eps lb_mwvcsmallgf_lowg_none_dvcbs_f_eps lb_mostconnectednodes_lowg_f_eps lb_gbfhs_gbfhs_f_eps lb_gbfhs_gbfhs_f_eps_uf


    # UF versions of DVCHS, GBFHS, Most connected, SmallestG, smallestGF run on all std problems:
    ...
    "lb_mwvcsmallgf_lowg_none_dvcbs_f_eps_uf": {"class": bd_lb_search, "tb_dir": 'SBM0', "tb_select": 'SLG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True},  
    ...
    "lb_gbfhs_lowg_f_eps_uf": {"class": bd_lb_search, "tb_dir": 'GBF', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True},  
    "lb_mostconnectednodes_lowg_f_eps_uf": {"class": bd_lb_search, "tb_dir": 'LN0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True},  
    "lb_smallg_lowg_none_f_eps_uf": {"class": bd_lb_search, "tb_dir": 'S0', "tb_select": 'LG', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True},  
    "lb_smallgf_smallblowg_f_eps_uf": {"class": bd_lb_search, "tb_dir": 'SB', "tb_select": 'SBL', "tb_order": 'NONE', "version": 'F', "min_edge_cost": 1.0, "data_struct": 'B', 'switch_after_U_set':True},  

    # lb_mwvcsmallg_lowg_none_dvcbs_a_eps_uf lb_mwvcsmallg_lowg_none_dvcbs_f_eps_uf lb_mwvcsmallgf_lowg_none_dvcbs_f_eps_uf lb_gbfhs_gbfhs_f_eps_uf lb_gbfhs_lowg_f_eps_uf lb_mostconnectednodes_lowg_f_eps_uf lb_smallg_lowg_none_f_eps_uf lb_smallgf_smallblowg_f_eps_uf
