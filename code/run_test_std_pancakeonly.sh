...
python search_runner.py \
        --out_dir "../outputs" \
        --out_prefix "lbpairs_verA_STD_PAN_ONLY_search-eval" \
        --in_dir "../problems" \
        --seed 42 \
        --grid daostd \
        --grid_max_per_scen 0 \
        ...
        --algo_timeout 2880 \
        --algo_min_remaining_gb 2.0 \
        --algo_heur lb_mwvcsmallg_mwvcsmallg_none_a_eps lb_mwvcsmallg_lowg_fifo_dvcbs_a_eps lb_mostconnectednodes_connln_a_eps lb_mwvcmostconnectednodes_mwvcconnln_a_eps lb_mwvcmostconnectednodes_lowg_a_eps \
        --algo_mcts NONE
