...
2. Run _maturin develop --release_ on the command line to compile the Rust library _.../code/src/lib.rs_ as an Python package _rust_utils_. 
3. Add a _--rust_heur_ flag to your run script to run the Rust version of manhattan heuristic for Sliding Tile. Speeds up 4x4 Sliding Tile problems by 20% or so.
